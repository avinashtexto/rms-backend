...
router.put('/company', blockForWarehouseManager as any, requirePermission('settings:manage') as any, SettingController.updateCompanySettings as any);

// Reason Codes
router.get('/reason-codes', requirePermission('settings:view') as any, SettingController.listReasonCodes as any);
router.post('/reason-codes', blockForWarehouseManager as any, requirePermission('settings:manage') as any, SettingController.createReasonCode as any);
