...
router.get('/', blockForWarehouseManager as any, requirePermission('user:manage') as any, UsersController.list as any);
router.post('/', blockForWarehouseManager as any, requirePermission('user:manage') as any, UsersController.create as any);
router.get('/:id', blockForWarehouseManager as any, requirePermission('user:manage') as any, UsersController.get as any);
